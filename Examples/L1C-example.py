...
fileName = (
    "/Users/aputhukkudy/Downloads/PACE/OCI-Dark/PACE_HARP2.20240307T125735.L1C.5km.nc"
)
...
plt_.plotPixelVars(
    pixel[0], pixel[1], xAxis="view_angles", alpha=0.5, linewidth=0.5, ms=2
)

plt_.reflectance = False  # switching back to radiance
plt_.plotPixelVars(
    pixel[0], pixel[1], xAxis="scattering_angle", alpha=0.5, linewidth=0.5, ms=2
)
...
plt_.bands2plot = [
    ...
    "red",
    "nir",
]  # Order in the list is the order of plotting
...
plt_.plotPixelVars(
    pixel[0],
    pixel[1],
    bands=plt_.bands2plot,
    xAxis="view_angles",
    showUnit=False,
    alpha=0.5,
    linewidth=0.5,
)  # you can pass any other arguments to the plot function
