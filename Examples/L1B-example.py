...
fileName = "/Users/aputhukkudy/Downloads/PACE_HARP2.20240924T172321.L1B.V3.nc"
...
plt.colorbar()
plt.title(
    "Variable: {} at viewing angle: {} \nspectral band: {} nm".format(
        var2plot,
        str(l1b_dict["view_angles"][angleIdx]),
        str(l1b_dict["intensity_wavelength"][angleIdx]),
    )
)
plt.show()
