...
def plotL1C(args):
    ...
    plt_.projectedRGB(
        ...
        figsize=(5, 5),
        noShow=True,
        savePath=args.save_path.replace(".png", "_orthographic.png"),
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_path", type=str, required=False, help="path to the quicklook png file"
    )
